    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://embed.tawk.to https://*.tawk.to https://www.googletagmanager.com https://vercel.live https://accounts.google.com https://*.google.com https://cdn.jsdelivr.net https://tfhub.dev https://*.kaggle.com blob:",
