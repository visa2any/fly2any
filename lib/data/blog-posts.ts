...
export const sampleBlogPosts: BlogPost[] = [
  ...
  // B2B WHOLESALE TRAVEL PLATFORM ANALYSIS
  {
    ...
    content: 'Premium article - see dedicated article file',
    featuredImage: {
      url: 'https://images.unsplash.com/photo-1488646953014-85cb44e25328?w=1920&q=90',
      alt: 'Professional travel agent working on laptop with booking platform',
      credit: 'Photo by Austin Distel / Unsplash',
      width: 1920,
      height: 1080,
    },
    category: 'guide',
  ...
  // AFFILIATE MONETIZATION ECONOMICS ANALYSIS
  {
    ...
    content: 'Premium article - see dedicated article file',
    featuredImage: {
      url: 'https://images.unsplash.com/photo-1559028062-9d4d921c0e8-98869d5b1d5b?w=1920&q=90',
