...
const AIRPORTS_NORTH_AMERICA: Airport[] = [
  // ===== UNITED STATES ===== (All 50 states + DC + territories covered)

  // New York Metro (NYC) - New York & New Jersey
  { code: 'JFK', icao: 'KJFK', name: 'John F. Kennedy International', city: 'New York', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 40.6413, lon: -73.7781 }, flag: '🇺🇸', emoji: '🗽', popular: true, metro: 'NYC', state: 'New York' },
  { code: 'LGA', icao: 'KLGA', name: 'LaGuardia Airport', city: 'New York', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 40.7769, lon: -73.8740 }, flag: '🇺🇸', emoji: '🗽', popular: true, metro: 'NYC', state: 'New York' },
  { code: 'EWR', icao: 'KEWR', name: 'Newark Liberty International', city: 'Newark', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 40.6895, lon: -74.1745 }, flag: '🇺🇸', emoji: '🗽', popular: true, metro: 'NYC', state: 'New Jersey' },

  // Los Angeles Metro (LAX) - California
  { code: 'LAX', icao: 'KLAX', name: 'Los Angeles International', city: 'Los Angeles', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 33.9416, lon: -118.4085 }, flag: '🇺🇸', emoji: '🌴', popular: true, metro: 'LAX', state: 'California' },
  { code: 'SNA', icao: 'KSNA', name: 'John Wayne Airport', city: 'Santa Ana', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 33.6757, lon: -117.8682 }, flag: '🇺🇸', emoji: '🌴', popular: false, metro: 'LAX', state: 'California' },
  { code: 'ONT', icao: 'KONT', name: 'Ontario International', city: 'Ontario', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 34.0560, lon: -117.6012 }, flag: '🇺🇸', emoji: '🌴', popular: false, metro: 'LAX', state: 'California' },
  { code: 'BUR', icao: 'KBUR', name: 'Hollywood Burbank Airport', city: 'Burbank', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 34.2007, lon: -118.3587 }, flag: '🇺🇸', emoji: '🌴', popular: false, metro: 'LAX', state: 'California' },
  { code: 'LGB', icao: 'KLGB', name: 'Long Beach Airport', city: 'Long Beach', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 33.8177, lon: -118.1516 }, flag: '🇺🇸', emoji: '🌴', popular: false, metro: 'LAX', state: 'California' },

  // Major California Airports
  { code: 'SFO', icao: 'KSFO', name: 'San Francisco International', city: 'San Francisco', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 37.6213, lon: -122.3790 }, flag: '🇺🇸', emoji: '🌉', popular: true, state: 'California' },
  { code: 'SAN', icao: 'KSAN', name: 'San Diego International', city: 'San Diego', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 32.7336, lon: -117.1897 }, flag: '🇺🇸', emoji: '🌊', popular: true, state: 'California' },
  { code: 'SJC', icao: 'KSJC', name: 'Norman Y. Mineta San Jose International', city: 'San Jose', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 37.3639, lon: -121.9289 }, flag: '🇺🇸', emoji: '💻', popular: true, state: 'California' },
  { code: 'OAK', icao: 'KOAK', name: 'Oakland International', city: 'Oakland', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 37.7213, lon: -122.2208 }, flag: '🇺🇸', emoji: '🌉', popular: false, state: 'California' },
  { code: 'SMF', icao: 'KSMF', name: 'Sacramento International', city: 'Sacramento', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 38.6954, lon: -121.5908 }, flag: '🇺🇸', emoji: '🏛️', popular: false, state: 'California' },
  { code: 'PSP', icao: 'KPSP', name: 'Palm Springs International', city: 'Palm Springs', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 33.8297, lon: -116.5067 }, flag: '🇺🇸', emoji: '🏜️', popular: false, state: 'California' },
  { code: 'SBA', icao: 'KSBA', name: 'Santa Barbara Airport', city: 'Santa Barbara', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 34.4262, lon: -119.8405 }, flag: '🇺🇸', emoji: '🌴', popular: false, state: 'California' },
  { code: 'FAT', icao: 'KFAT', name: 'Fresno Yosemite International', city: 'Fresno', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 36.7762, lon: -119.7181 }, flag: '🇺🇸', emoji: '🏔️', popular: false, state: 'California' },

  // Major US Hubs by State
  { code: 'ATL', icao: 'KATL', name: 'Hartsfield-Jackson Atlanta International', city: 'Atlanta', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 33.6407, lon: -84.4277 }, flag: '🇺🇸', emoji: '🍑', popular: true, state: 'Georgia' },
  { code: 'ORD', icao: 'KORD', name: "O'Hare International", city: 'Chicago', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 41.9742, lon: -87.9073 }, flag: '🇺🇸', emoji: '🏙️', popular: true, state: 'Illinois' },
  { code: 'MDW', icao: 'KMDW', name: 'Chicago Midway International', city: 'Chicago', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 41.7868, lon: -87.7522 }, flag: '🇺🇸', emoji: '🏙️', popular: false, state: 'Illinois' },
  { code: 'DFW', icao: 'KDFW', name: 'Dallas/Fort Worth International', city: 'Dallas', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 32.8998, lon: -97.0403 }, flag: '🇺🇸', emoji: '🤠', popular: true, state: 'Texas' },
  { code: 'DAL', icao: 'KDAL', name: 'Dallas Love Field', city: 'Dallas', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 32.8470, lon: -96.8517 }, flag: '🇺🇸', emoji: '🤠', popular: false, state: 'Texas' },
  { code: 'IAH', icao: 'KIAH', name: 'George Bush Intercontinental', city: 'Houston', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 29.9902, lon: -95.3368 }, flag: '🇺🇸', emoji: '🛢️', popular: true, state: 'Texas' },
  { code: 'HOU', icao: 'KHOU', name: 'William P. Hobby Airport', city: 'Houston', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 29.6454, lon: -95.2789 }, flag: '🇺🇸', emoji: '🛢️', popular: false, state: 'Texas' },
  { code: 'AUS', icao: 'KAUS', name: 'Austin-Bergstrom International', city: 'Austin', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 30.1945, lon: -97.6700 }, flag: '🇺🇸', emoji: '🎸', popular: true, state: 'Texas' },
  { code: 'SAT', icao: 'KSAT', name: 'San Antonio International', city: 'San Antonio', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 29.5337, lon: -98.4698 }, flag: '🇺🇸', emoji: '🤠', popular: true, state: 'Texas' },
  { code: 'ELP', icao: 'KELP', name: 'El Paso International', city: 'El Paso', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Denver', coordinates: { lat: 31.8072, lon: -106.3778 }, flag: '🇺🇸', emoji: '🌵', popular: false, state: 'Texas' },
  { code: 'DEN', icao: 'KDEN', name: 'Denver International', city: 'Denver', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Denver', coordinates: { lat: 39.8561, lon: -104.6737 }, flag: '🇺🇸', emoji: '🏔️', popular: true, state: 'Colorado' },
  { code: 'COS', icao: 'KCOS', name: 'Colorado Springs Airport', city: 'Colorado Springs', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Denver', coordinates: { lat: 38.8058, lon: -104.7006 }, flag: '🇺🇸', emoji: '🏔️', popular: false, state: 'Colorado' },
  { code: 'SEA', icao: 'KSEA', name: 'Seattle-Tacoma International', city: 'Seattle', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 47.4502, lon: -122.3088 }, flag: '🇺🇸', emoji: '☕', popular: true, state: 'Washington' },
  { code: 'GEG', icao: 'KGEG', name: 'Spokane International', city: 'Spokane', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 47.6199, lon: -117.5338 }, flag: '🇺🇸', emoji: '🌲', popular: false, state: 'Washington' },
  { code: 'LAS', icao: 'KLAS', name: 'Harry Reid International', city: 'Las Vegas', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 36.0840, lon: -115.1537 }, flag: '🇺🇸', emoji: '🎰', popular: true, state: 'Nevada' },
  { code: 'RNO', icao: 'KRNO', name: 'Reno-Tahoe International', city: 'Reno', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 39.4991, lon: -119.7681 }, flag: '🇺🇸', emoji: '🎰', popular: false, state: 'Nevada' },
  { code: 'PHX', icao: 'KPHX', name: 'Phoenix Sky Harbor International', city: 'Phoenix', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Phoenix', coordinates: { lat: 33.4352, lon: -112.0101 }, flag: '🇺🇸', emoji: '🌵', popular: true, state: 'Arizona' },
  { code: 'TUS', icao: 'KTUS', name: 'Tucson International', city: 'Tucson', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Phoenix', coordinates: { lat: 32.1161, lon: -110.9410 }, flag: '🇺🇸', emoji: '🌵', popular: false, state: 'Arizona' },

  // Florida
  { code: 'MIA', icao: 'KMIA', name: 'Miami International', city: 'Miami', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 25.7959, lon: -80.2870 }, flag: '🇺🇸', emoji: '🏖️', popular: true, state: 'Florida' },
  { code: 'FLL', icao: 'KFLL', name: 'Fort Lauderdale-Hollywood International', city: 'Fort Lauderdale', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 26.0742, lon: -80.1506 }, flag: '🇺🇸', emoji: '🏖️', popular: true, state: 'Florida' },
  { code: 'MCO', icao: 'KMCO', name: 'Orlando International', city: 'Orlando', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 28.4312, lon: -81.3081 }, flag: '🇺🇸', emoji: '🏰', popular: true, state: 'Florida' },
  { code: 'TPA', icao: 'KTPA', name: 'Tampa International', city: 'Tampa', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 27.9755, lon: -82.5332 }, flag: '🇺🇸', emoji: '🏴‍☠️', popular: true, state: 'Florida' },
  { code: 'PBI', icao: 'KPBI', name: 'Palm Beach International', city: 'West Palm Beach', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 26.6832, lon: -80.0956 }, flag: '🇺🇸', emoji: '🌴', popular: false, state: 'Florida' },
  { code: 'RSW', icao: 'KRSW', name: 'Southwest Florida International', city: 'Fort Myers', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 26.5361, lon: -81.7552 }, flag: '🇺🇸', emoji: '🏖️', popular: false, state: 'Florida' },
  { code: 'JAX', icao: 'KJAX', name: 'Jacksonville International', city: 'Jacksonville', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 30.4941, lon: -81.6879 }, flag: '🇺🇸', emoji: '🐊', popular: false, state: 'Florida' },
  { code: 'SRQ', icao: 'KSRQ', name: 'Sarasota-Bradenton International', city: 'Sarasota', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 27.3954, lon: -82.5544 }, flag: '🇺🇸', emoji: '🏖️', popular: false, state: 'Florida' },

  // Northeast
  { code: 'BOS', icao: 'KBOS', name: 'Logan International', city: 'Boston', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 42.3656, lon: -71.0096 }, flag: '🇺🇸', emoji: '🦞', popular: true, state: 'Massachusetts' },
  { code: 'PHL', icao: 'KPHL', name: 'Philadelphia International', city: 'Philadelphia', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 39.8744, lon: -75.2424 }, flag: '🇺🇸', emoji: '🔔', popular: true, state: 'Pennsylvania' },
  { code: 'PIT', icao: 'KPIT', name: 'Pittsburgh International', city: 'Pittsburgh', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 40.4915, lon: -80.2329 }, flag: '🇺🇸', emoji: '🏒', popular: false, state: 'Pennsylvania' },
  { code: 'PVD', icao: 'KPVD', name: 'T.F. Green International', city: 'Providence', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 41.7240, lon: -71.4282 }, flag: '🇺🇸', emoji: '⛵', popular: false, state: 'Rhode Island' },
  { code: 'BDL', icao: 'KBDL', name: 'Bradley International', city: 'Hartford', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 41.9389, lon: -72.6832 }, flag: '🇺🇸', emoji: '🏛️', popular: false, state: 'Connecticut' },
  { code: 'MHT', icao: 'KMHT', name: 'Manchester-Boston Regional', city: 'Manchester', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 42.9326, lon: -71.4357 }, flag: '🇺🇸', emoji: '🏔️', popular: false, state: 'New Hampshire' },
  { code: 'BTV', icao: 'KBTV', name: 'Burlington International', city: 'Burlington', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 44.4720, lon: -73.1533 }, flag: '🇺🇸', emoji: '🍁', popular: false, state: 'Vermont' },
  { code: 'PWM', icao: 'KPWM', name: 'Portland International Jetport', city: 'Portland', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 43.6463, lon: -70.3093 }, flag: '🇺🇸', emoji: '🦞', popular: false, state: 'Maine' },

  // Mid-Atlantic & DC Area
  { code: 'DCA', icao: 'KDCA', name: 'Ronald Reagan Washington National', city: 'Washington DC', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 38.8521, lon: -77.0377 }, flag: '🇺🇸', emoji: '🏛️', popular: true, state: 'District of Columbia' },
  { code: 'IAD', icao: 'KIAD', name: 'Washington Dulles International', city: 'Washington DC', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 38.9531, lon: -77.4565 }, flag: '🇺🇸', emoji: '🏛️', popular: true, state: 'Virginia' },
  { code: 'BWI', icao: 'KBWI', name: 'Baltimore/Washington International', city: 'Baltimore', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 39.1774, lon: -76.6684 }, flag: '🇺🇸', emoji: '🦀', popular: false, state: 'Maryland' },
  { code: 'RIC', icao: 'KRIC', name: 'Richmond International', city: 'Richmond', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 37.5052, lon: -77.3197 }, flag: '🇺🇸', emoji: '🏛️', popular: false, state: 'Virginia' },
  { code: 'ORF', icao: 'KORF', name: 'Norfolk International', city: 'Norfolk', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 36.8946, lon: -76.2012 }, flag: '🇺🇸', emoji: '⚓', popular: false, state: 'Virginia' },

  // Southeast
  { code: 'CLT', icao: 'KCLT', name: 'Charlotte Douglas International', city: 'Charlotte', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 35.2144, lon: -80.9473 }, flag: '🇺🇸', emoji: '🏛️', popular: true, state: 'North Carolina' },
  { code: 'RDU', icao: 'KRDU', name: 'Raleigh-Durham International', city: 'Raleigh', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 35.8776, lon: -78.7875 }, flag: '🇺🇸', emoji: '🎓', popular: true, state: 'North Carolina' },
  { code: 'CHS', icao: 'KCHS', name: 'Charleston International', city: 'Charleston', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 32.8986, lon: -80.0405 }, flag: '🇺🇸', emoji: '🌴', popular: false, state: 'South Carolina' },
  { code: 'MYR', icao: 'KMYR', name: 'Myrtle Beach International', city: 'Myrtle Beach', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 33.6797, lon: -78.9283 }, flag: '🇺🇸', emoji: '🏖️', popular: false, state: 'South Carolina' },
  { code: 'SAV', icao: 'KSAV', name: 'Savannah/Hilton Head International', city: 'Savannah', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 32.1276, lon: -81.2021 }, flag: '🇺🇸', emoji: '🌳', popular: false, state: 'Georgia' },
  { code: 'BNA', icao: 'KBNA', name: 'Nashville International', city: 'Nashville', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 36.1263, lon: -86.6892 }, flag: '🇺🇸', emoji: '🎸', popular: true, state: 'Tennessee' },
  { code: 'MEM', icao: 'KMEM', name: 'Memphis International', city: 'Memphis', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 35.0424, lon: -89.9767 }, flag: '🇺🇸', emoji: '🎵', popular: false, state: 'Tennessee' },
  { code: 'BHM', icao: 'KBHM', name: 'Birmingham-Shuttlesworth International', city: 'Birmingham', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 33.5629, lon: -86.7535 }, flag: '🇺🇸', emoji: '🏭', popular: false, state: 'Alabama' },
  { code: 'MSY', icao: 'KMSY', name: 'Louis Armstrong New Orleans International', city: 'New Orleans', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 29.9934, lon: -90.2580 }, flag: '🇺🇸', emoji: '🎺', popular: true, state: 'Louisiana' },
  { code: 'JAN', icao: 'KJAN', name: 'Jackson-Medgar Wiley Evers International', city: 'Jackson', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 32.3112, lon: -90.0759 }, flag: '🇺🇸', emoji: '🌳', popular: false, state: 'Mississippi' },
  { code: 'LIT', icao: 'KLIT', name: 'Bill and Hillary Clinton National', city: 'Little Rock', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 34.7294, lon: -92.2243 }, flag: '🇺🇸', emoji: '💎', popular: false, state: 'Arkansas' },
  { code: 'SDF', icao: 'KSDF', name: 'Louisville International', city: 'Louisville', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Kentucky/Louisville', coordinates: { lat: 38.1744, lon: -85.7360 }, flag: '🇺🇸', emoji: '🏇', popular: false, state: 'Kentucky' },
  { code: 'CRW', icao: 'KCRW', name: 'Yeager Airport', city: 'Charleston', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 38.3731, lon: -81.5932 }, flag: '🇺🇸', emoji: '🏔️', popular: false, state: 'West Virginia' },

  // Midwest
  { code: 'MSP', icao: 'KMSP', name: 'Minneapolis-St Paul International', city: 'Minneapolis', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 44.8820, lon: -93.2218 }, flag: '🇺🇸', emoji: '❄️', popular: true, state: 'Minnesota' },
  { code: 'DTW', icao: 'KDTW', name: 'Detroit Metropolitan Wayne County', city: 'Detroit', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Detroit', coordinates: { lat: 42.2124, lon: -83.3534 }, flag: '🇺🇸', emoji: '🚗', popular: true, state: 'Michigan' },
  { code: 'GRR', icao: 'KGRR', name: 'Gerald R. Ford International', city: 'Grand Rapids', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Detroit', coordinates: { lat: 42.8808, lon: -85.5228 }, flag: '🇺🇸', emoji: '🌲', popular: false, state: 'Michigan' },
  { code: 'SLC', icao: 'KSLC', name: 'Salt Lake City International', city: 'Salt Lake City', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Denver', coordinates: { lat: 40.7899, lon: -111.9791 }, flag: '🇺🇸', emoji: '⛷️', popular: true, state: 'Utah' },
  { code: 'IND', icao: 'KIND', name: 'Indianapolis International', city: 'Indianapolis', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Indiana/Indianapolis', coordinates: { lat: 39.7173, lon: -86.2944 }, flag: '🇺🇸', emoji: '🏎️', popular: false, state: 'Indiana' },
  { code: 'CMH', icao: 'KCMH', name: 'John Glenn Columbus International', city: 'Columbus', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 39.9980, lon: -82.8919 }, flag: '🇺🇸', emoji: '🏈', popular: false, state: 'Ohio' },
  { code: 'CLE', icao: 'KCLE', name: 'Cleveland Hopkins International', city: 'Cleveland', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 41.4117, lon: -81.8498 }, flag: '🇺🇸', emoji: '🎸', popular: false, state: 'Ohio' },
  { code: 'CVG', icao: 'KCVG', name: 'Cincinnati/Northern Kentucky International', city: 'Cincinnati', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/New_York', coordinates: { lat: 39.0531, lon: -84.6630 }, flag: '🇺🇸', emoji: '🏈', popular: false, state: 'Kentucky' },
  { code: 'MCI', icao: 'KMCI', name: 'Kansas City International', city: 'Kansas City', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 39.2976, lon: -94.7139 }, flag: '🇺🇸', emoji: '🥩', popular: false, state: 'Missouri' },
  { code: 'STL', icao: 'KSTL', name: 'St. Louis Lambert International', city: 'St. Louis', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 38.7499, lon: -90.3700 }, flag: '🇺🇸', emoji: '🎺', popular: false, state: 'Missouri' },
  { code: 'MKE', icao: 'KMKE', name: 'Milwaukee Mitchell International', city: 'Milwaukee', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 42.9472, lon: -87.8966 }, flag: '🇺🇸', emoji: '🍺', popular: false, state: 'Wisconsin' },
  { code: 'DSM', icao: 'KDSM', name: 'Des Moines International', city: 'Des Moines', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 41.5340, lon: -93.6631 }, flag: '🇺🇸', emoji: '🌽', popular: false, state: 'Iowa' },
  { code: 'OMA', icao: 'KOMA', name: 'Eppley Airfield', city: 'Omaha', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 41.3032, lon: -95.8941 }, flag: '🇺🇸', emoji: '🥩', popular: false, state: 'Nebraska' },
  { code: 'ICT', icao: 'KICT', name: 'Wichita Dwight D. Eisenhower National', city: 'Wichita', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 37.6499, lon: -97.4331 }, flag: '🇺🇸', emoji: '✈️', popular: false, state: 'Kansas' },
  { code: 'OKC', icao: 'KOKC', name: 'Will Rogers World Airport', city: 'Oklahoma City', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 35.3931, lon: -97.6007 }, flag: '🇺🇸', emoji: '🤠', popular: false, state: 'Oklahoma' },
  { code: 'TUL', icao: 'KTUL', name: 'Tulsa International', city: 'Tulsa', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 36.1984, lon: -95.8881 }, flag: '🇺🇸', emoji: '🛢️', popular: false, state: 'Oklahoma' },

  // Mountain West & Northwest
  { code: 'PDX', icao: 'KPDX', name: 'Portland International', city: 'Portland', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 45.5898, lon: -122.5951 }, flag: '🇺🇸', emoji: '🌲', popular: true, state: 'Oregon' },
  { code: 'EUG', icao: 'KEUG', name: 'Eugene Airport', city: 'Eugene', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Los_Angeles', coordinates: { lat: 44.1246, lon: -123.2119 }, flag: '🇺🇸', emoji: '🦆', popular: false, state: 'Oregon' },
  { code: 'BOI', icao: 'KBOI', name: 'Boise Airport', city: 'Boise', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Boise', coordinates: { lat: 43.5644, lon: -116.2228 }, flag: '🇺🇸', emoji: '🏔️', popular: false, state: 'Idaho' },
  { code: 'ABQ', icao: 'KABQ', name: 'Albuquerque International Sunport', city: 'Albuquerque', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Denver', coordinates: { lat: 35.0402, lon: -106.6092 }, flag: '🇺🇸', emoji: '🎈', popular: false, state: 'New Mexico' },
  { code: 'SAF', icao: 'KSAF', name: 'Santa Fe Regional Airport', city: 'Santa Fe', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Denver', coordinates: { lat: 35.6171, lon: -106.0883 }, flag: '🇺🇸', emoji: '🎨', popular: false, state: 'New Mexico' },
  { code: 'BZN', icao: 'KBZN', name: 'Bozeman Yellowstone International', city: 'Bozeman', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Denver', coordinates: { lat: 45.7775, lon: -111.1530 }, flag: '🇺🇸', emoji: '🦬', popular: false, state: 'Montana' },
  { code: 'MSO', icao: 'KMSO', name: 'Missoula Montana Airport', city: 'Missoula', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Denver', coordinates: { lat: 46.9163, lon: -114.0906 }, flag: '🇺🇸', emoji: '🏔️', popular: false, state: 'Montana' },
  { code: 'JAC', icao: 'KJAC', name: 'Jackson Hole Airport', city: 'Jackson', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Denver', coordinates: { lat: 43.6073, lon: -110.7377 }, flag: '🇺🇸', emoji: '🎿', popular: true, state: 'Wyoming' },
  { code: 'FAR', icao: 'KFAR', name: 'Hector International', city: 'Fargo', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 46.9207, lon: -96.8158 }, flag: '🇺🇸', emoji: '❄️', popular: false, state: 'North Dakota' },
  { code: 'FSD', icao: 'KFSD', name: 'Sioux Falls Regional', city: 'Sioux Falls', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Chicago', coordinates: { lat: 43.5820, lon: -96.7419 }, flag: '🇺🇸', emoji: '🌾', popular: false, state: 'South Dakota' },
  { code: 'RAP', icao: 'KRAP', name: 'Rapid City Regional', city: 'Rapid City', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Denver', coordinates: { lat: 44.0453, lon: -103.0574 }, flag: '🇺🇸', emoji: '🗿', popular: false, state: 'South Dakota' },

  // Hawaii
  { code: 'HNL', icao: 'PHNL', name: 'Daniel K. Inouye International', city: 'Honolulu', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'Pacific/Honolulu', coordinates: { lat: 21.3187, lon: -157.9225 }, flag: '🇺🇸', emoji: '🌺', popular: true, state: 'Hawaii' },
  { code: 'OGG', icao: 'PHOG', name: 'Kahului Airport', city: 'Maui', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'Pacific/Honolulu', coordinates: { lat: 20.8986, lon: -156.4306 }, flag: '🇺🇸', emoji: '🌺', popular: true, state: 'Hawaii' },
  { code: 'LIH', icao: 'PHLI', name: 'Lihue Airport', city: 'Kauai', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'Pacific/Honolulu', coordinates: { lat: 21.9760, lon: -159.3389 }, flag: '🇺🇸', emoji: '🌺', popular: true, state: 'Hawaii' },
  { code: 'KOA', icao: 'PHKO', name: 'Ellison Onizuka Kona International', city: 'Kona', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'Pacific/Honolulu', coordinates: { lat: 19.7388, lon: -156.0456 }, flag: '🇺🇸', emoji: '🌋', popular: true, state: 'Hawaii' },
  { code: 'ITO', icao: 'PHTO', name: 'Hilo International', city: 'Hilo', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'Pacific/Honolulu', coordinates: { lat: 19.7214, lon: -155.0485 }, flag: '🇺🇸', emoji: '🌋', popular: false, state: 'Hawaii' },

  // Alaska
  { code: 'ANC', icao: 'PANC', name: 'Ted Stevens Anchorage International', city: 'Anchorage', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Anchorage', coordinates: { lat: 61.1743, lon: -149.9962 }, flag: '🇺🇸', emoji: '🏔️', popular: false, state: 'Alaska' },
  { code: 'FAI', icao: 'PAFA', name: 'Fairbanks International', city: 'Fairbanks', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Anchorage', coordinates: { lat: 64.8151, lon: -147.8561 }, flag: '🇺🇸', emoji: '🌌', popular: false, state: 'Alaska' },
  { code: 'JNU', icao: 'PAJN', name: 'Juneau International', city: 'Juneau', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Juneau', coordinates: { lat: 58.3549, lon: -134.5762 }, flag: '🇺🇸', emoji: '🐻', popular: false, state: 'Alaska' },

  // US Territories
  { code: 'SJU', icao: 'TJSJ', name: 'Luis Muñoz Marín International', city: 'San Juan', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Puerto_Rico', coordinates: { lat: 18.4394, lon: -66.0018 }, flag: '🇵🇷', emoji: '🏝️', popular: true, state: 'Puerto Rico' },
  { code: 'STT', icao: 'TIST', name: 'Cyril E. King Airport', city: 'Charlotte Amalie', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'America/Virgin', coordinates: { lat: 18.3373, lon: -64.9734 }, flag: '🇻🇮', emoji: '🏝️', popular: false, state: 'US Virgin Islands' },
  { code: 'GUM', icao: 'PGUM', name: 'Antonio B. Won Pat International', city: 'Tamuning', country: 'United States', countryCode: 'US', continent: 'NA', timezone: 'Pacific/Guam', coordinates: { lat: 13.4834, lon: 144.7959 }, flag: '🇬🇺', emoji: '🏝️', popular: false, state: 'Guam' },
