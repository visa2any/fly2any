...
const AIRPORTS_SOUTH_AMERICA: Airport[] = [
  ...
  // Buenos Aires Metro (BUE)
  { code: 'EZE', icao: 'SAEZ', name: 'Ministro Pistarini International (Ezeiza)', city: 'Buenos Aires', country: 'Argentina', countryCode: 'AR', continent: 'SA', timezone: 'America/Argentina/Buenos_Aires', coordinates: { lat: -34.8222, lon: -58.5358 }, flag: '🇦🇷', emoji: '🥩', popular: true, metro: 'BUE' },
  { code: 'AEP', icao: 'SABE', name: 'Aeroparque Jorge Newbery', city: 'Buenos Aires', country: 'Argentina', countryCode: 'AR', continent: 'SA', timezone: 'America/Argentina/Buenos_Aires', coordinates: { lat: -34.5592, lon: -58.4156 }, flag: '🇦🇷', emoji: '🥩', popular: true, metro: 'BUE' },

  // Other Argentine Cities
  { code: 'COR', icao: 'SACO', name: 'Ingeniero Ambrosio Taravella International', city: 'Córdoba', country: 'Argentina', countryCode: 'AR', continent: 'SA', timezone: 'America/Argentina/Cordoba', coordinates: { lat: -31.3236, lon: -64.2080 }, flag: '🇦🇷', emoji: '🏛️', popular: false },
  { code: 'MDZ', icao: 'SAME', name: 'Governor Francisco Gabrielli International', city: 'Mendoza', country: 'Argentina', countryCode: 'AR', continent: 'SA', timezone: 'America/Argentina/Mendoza', coordinates: { lat: -32.8317, lon: -68.7928 }, flag: '🇦🇷', emoji: '🍷', popular: false },
  { code: 'IGR', icao: 'SARI', name: 'Cataratas del Iguazú International', city: 'Iguazu Falls', country: 'Argentina', countryCode: 'AR', continent: 'SA', timezone: 'America/Argentina/Buenos_Aires', coordinates: { lat: -25.7373, lon: -54.4734 }, flag: '🇦🇷', emoji: '💧', popular: true },
  { code: 'USH', icao: 'SAWH', name: 'Malvinas Argentinas Ushuaia International', city: 'Ushuaia', country: 'Argentina', countryCode: 'AR', continent: 'SA', timezone: 'America/Argentina/Ushuaia', coordinates: { lat: -54.8433, lon: -68.2958 }, flag: '🇦🇷', emoji: '🐧', popular: true },

  // ===== CHILE =====
  { code: 'SCL', icao: 'SCEL', name: 'Arturo Merino Benítez International', city: 'Santiago', country: 'Chile', countryCode: 'CL', continent: 'SA', timezone: 'America/Santiago', coordinates: { lat: -33.3930, lon: -70.7858 }, flag: '🇨🇱', emoji: '🏔️', popular: true },
  { code: 'IPC', icao: 'SCIP', name: 'Mataveri International', city: 'Easter Island', country: 'Chile', countryCode: 'CL', continent: 'SA', timezone: 'Pacific/Easter', coordinates: { lat: -27.1648, lon: -109.4219 }, flag: '🇨🇱', emoji: '🗿', popular: true, searchKeywords: ['Rapa Nui', 'Easter Island'] },
  { code: 'ANF', icao: 'SCFA', name: 'Andrés Sabella Gálvez International', city: 'Antofagasta', country: 'Chile', countryCode: 'CL', continent: 'SA', timezone: 'America/Santiago', coordinates: { lat: -23.4445, lon: -70.4451 }, flag: '🇨🇱', emoji: '🏜️', popular: false },

  // ===== COLOMBIA =====
  { code: 'BOG', icao: 'SKBO', name: 'El Dorado International', city: 'Bogotá', country: 'Colombia', countryCode: 'CO', continent: 'SA', timezone: 'America/Bogota', coordinates: { lat: 4.7016, lon: -74.1469 }, flag: '🇨🇴', emoji: '☕', popular: true },
  { code: 'MDE', icao: 'SKRG', name: 'José María Córdova International', city: 'Medellín', country: 'Colombia', countryCode: 'CO', continent: 'SA', timezone: 'America/Bogota', coordinates: { lat: 6.1644, lon: -75.4231 }, flag: '🇨🇴', emoji: '🌺', popular: true },
  { code: 'CTG', icao: 'SKCG', name: 'Rafael Núñez International', city: 'Cartagena', country: 'Colombia', countryCode: 'CO', continent: 'SA', timezone: 'America/Bogota', coordinates: { lat: 10.4424, lon: -75.5130 }, flag: '🇨🇴', emoji: '🏖️', popular: true },
  { code: 'CLO', icao: 'SKCL', name: 'Alfonso Bonilla Aragón International', city: 'Cali', country: 'Colombia', countryCode: 'CO', continent: 'SA', timezone: 'America/Bogota', coordinates: { lat: 3.5432, lon: -76.3816 }, flag: '🇨🇴', emoji: '💃', popular: false },
  { code: 'BAQ', icao: 'SKBQ', name: 'Ernesto Cortissoz International', city: 'Barranquilla', country: 'Colombia', countryCode: 'CO', continent: 'SA', timezone: 'America/Bogota', coordinates: { lat: 10.8896, lon: -74.7808 }, flag: '🇨🇴', emoji: '🎭', popular: false },

  // ===== PERU =====
  { code: 'LIM', icao: 'SPIM', name: 'Jorge Chávez International', city: 'Lima', country: 'Peru', countryCode: 'PE', continent: 'SA', timezone: 'America/Lima', coordinates: { lat: -12.0219, lon: -77.1143 }, flag: '🇵🇪', emoji: '🦙', popular: true },
  { code: 'CUZ', icao: 'SPZO', name: 'Alejandro Velasco Astete International', city: 'Cusco', country: 'Peru', countryCode: 'PE', continent: 'SA', timezone: 'America/Lima', coordinates: { lat: -13.5357, lon: -71.9388 }, flag: '🇵🇪', emoji: '🏔️', popular: true, searchKeywords: ['Machu Picchu'] },
  { code: 'AQP', icao: 'SPQU', name: 'Rodríguez Ballón International', city: 'Arequipa', country: 'Peru', countryCode: 'PE', continent: 'SA', timezone: 'America/Lima', coordinates: { lat: -16.3411, lon: -71.5831 }, flag: '🇵🇪', emoji: '🌋', popular: false },

  // ===== ECUADOR =====
  { code: 'UIO', icao: 'SEQM', name: 'Mariscal Sucre International', city: 'Quito', country: 'Ecuador', countryCode: 'EC', continent: 'SA', timezone: 'America/Guayaquil', coordinates: { lat: -0.1292, lon: -78.3575 }, flag: '🇪🇨', emoji: '🏔️', popular: true },
  { code: 'GYE', icao: 'SEGU', name: 'José Joaquín de Olmedo International', city: 'Guayaquil', country: 'Ecuador', countryCode: 'EC', continent: 'SA', timezone: 'America/Guayaquil', coordinates: { lat: -2.1574, lon: -79.8836 }, flag: '🇪🇨', emoji: '🏖️', popular: true },
  { code: 'GPS', icao: 'SEGS', name: 'Seymour Airport', city: 'Galapagos', country: 'Ecuador', countryCode: 'EC', continent: 'SA', timezone: 'Pacific/Galapagos', coordinates: { lat: -0.4538, lon: -90.2659 }, flag: '🇪🇨', emoji: '🐢', popular: true },

  // ===== URUGUAY =====
  { code: 'MVD', icao: 'SUMU', name: 'Carrasco International', city: 'Montevideo', country: 'Uruguay', countryCode: 'UY', continent: 'SA', timezone: 'America/Montevideo', coordinates: { lat: -34.8384, lon: -56.0308 }, flag: '🇺🇾', emoji: '⚽', popular: false },
  { code: 'PDP', icao: 'SULS', name: 'Capitán Carlos A. Curbelo International', city: 'Punta del Este', country: 'Uruguay', countryCode: 'UY', continent: 'SA', timezone: 'America/Montevideo', coordinates: { lat: -34.8551, lon: -55.0943 }, flag: '🇺🇾', emoji: '🏖️', popular: true },

  // ===== PARAGUAY =====
  { code: 'ASU', icao: 'SGAS', name: 'Silvio Pettirossi International', city: 'Asunción', country: 'Paraguay', countryCode: 'PY', continent: 'SA', timezone: 'America/Asuncion', coordinates: { lat: -25.2400, lon: -57.5197 }, flag: '🇵🇾', emoji: '🌳', popular: false },

  // ===== BOLIVIA =====
  { code: 'VVI', icao: 'SLVR', name: 'Viru Viru International', city: 'Santa Cruz', country: 'Bolivia', countryCode: 'BO', continent: 'SA', timezone: 'America/La_Paz', coordinates: { lat: -17.6448, lon: -63.1354 }, flag: '🇧🇴', emoji: '🌴', popular: false },
  { code: 'LPB', icao: 'SLLP', name: 'El Alto International', city: 'La Paz', country: 'Bolivia', countryCode: 'BO', continent: 'SA', timezone: 'America/La_Paz', coordinates: { lat: -16.5133, lon: -68.1925 }, flag: '🇧🇴', emoji: '🏔️', popular: false },

  // ===== VENEZUELA =====
  { code: 'CCS', icao: 'SVMI', name: 'Simón Bolívar International', city: 'Caracas', country: 'Venezuela', countryCode: 'VE', continent: 'SA', timezone: 'America/Caracas', coordinates: { lat: 10.6013, lon: -66.9912 }, flag: '🇻🇪', emoji: '🏔️', popular: false },

  // ===== GUYANA & SURINAME =====
  { code: 'GEO', icao: 'SYCJ', name: 'Cheddi Jagan International', city: 'Georgetown', country: 'Guyana', countryCode: 'GY', continent: 'SA', timezone: 'America/Guyana', coordinates: { lat: 6.4985, lon: -58.2541 }, flag: '🇬🇾', emoji: '🌴', popular: false },
  { code: 'PBM', icao: 'SMJP', name: 'Johan Adolf Pengel International', city: 'Paramaribo', country: 'Suriname', countryCode: 'SR', continent: 'SA', timezone: 'America/Paramaribo', coordinates: { lat: 5.4528, lon: -55.1878 }, flag: '🇸🇷', emoji: '🌴', popular: false },
];
