      ...
      >
        ...
        <div className="hidden lg:block">
          ...
          <div className="flex-shrink-0">
            ...
            <button
              ...
              disabled={isLoading}
              className="py-4 px-10 bg-[#0087FF] hover:bg-[#0077E6] text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 whitespace-nowrap text-sm"
            >
              {isLoading ? (
                <>
            ...
            <div ref={hotelDestinationRef} className="flex-1 relative">
              ...
              {selectedDestinationDetails && hotelDestination === selectedDestinationDetails.name ? (
                ...
                <input
                  ...
                  className={`w-full px-4 py-4 bg-white border rounded-lg hover:border-[#0087FF] transition-all text-sm font-medium ${
          ...
          <div className="flex items-end gap-3">
            ...
            <div className="flex-shrink-0">
              ...
              <button
                ...
                onClick={handleSearch}
                disabled={isLoading}
                className="py-4 px-10 bg-[#0087FF] hover:bg-[#0077E6] text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 whitespace-nowrap text-sm h-[56px]"
              >
                {isLoading ? (
                  <>
                    <svg className="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-4 py-4 bg-white border border-gray-300 rounded-lg hover:border-[#0087FF] transition-all text-sm font-medium"
              />
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-stretch lg:items-end gap-2">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-4 py-4 bg-white border border-gray-300 rounded-lg hover:border-[#0087FF] focus:outline-none focus:ring-2 focus:ring-[#0087FF] transition-all text-sm font-medium"
              />
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-stretch lg:items-end gap-2">
            ...
            <div className="flex-shrink-0">
              <label className="block text-xs font-medium text-gray-700 mb-2 opacity-0">Search</label>
              <button type="button" onClick={handleSearch} disabled={isLoading} className="py-4 px-10 bg-[#0087FF] hover:bg-[#0077E6] text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 whitespace-nowrap text-sm">
        ...
        <div className="lg:hidden space-y-2">
          ...
          <button
            onClick={handleSearch}
            disabled={isLoading}
            className="w-full h-10 bg-[#0087FF] hover:bg-[#0077E6] text-white font-bold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 ease-in-out text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {isLoading ? (
              <>
