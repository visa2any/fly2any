...
import EnterpriseFlightSearchForm from '@/components/flights/EnterpriseFlightSearchForm';
import UltraOptimizedFlightSearchForm from '@/components/flights/UltraOptimizedFlightSearchForm';
...
function FlightsPageContent() {
      ...
      case 'search':
        return (
          <div className="space-y-8">
            {/* 🚀 SIMPLIFIED HERO SECTION - Original Content with Optimized Form */}
            <SimpleHeroSection 
  ...
  return (
    <div className="min-h-screen">
      {/* Show global header on ALL views including search */}
      <ResponsiveHeader />
      <GlobalMobileStyles />
      ...
      {/* Main Content - Add padding for header on all views */}
