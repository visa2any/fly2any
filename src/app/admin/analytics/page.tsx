          ...
          <div className="admin-card-content">
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-admin-text-primary">R$ 245.000</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-admin-text-primary">Hospedagem</span>
                <span className="font-semibold text-admin-text-primary">R$ 89.000</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-admin-text-primary">Passagens</span>
                <span className="font-semibold text-admin-text-primary">R$ 156.000</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-admin-text-primary">Transfers</span>
                <span className="font-semibold text-admin-text-primary">R$ 23.000</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="admin-card">
          ...
          <div className="admin-card-content">
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <span className="text-admin-text-primary">Receita (Meta: R$ 500k)</span>
                  <span className="font-semibold">R$ 513k / R$ 500k</span>
                </div>
                <div className="w-full bg-admin-bg-secondary rounded-full h-3">
