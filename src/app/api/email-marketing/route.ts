...
// Templates PREMIUM OTIMIZADOS com estratégias avançadas de marketing
    ...
    html: `
        ...
        <style>
          * { box-sizing: border-box; }
          ...
          @media only screen and (max-width: 600px) {
            ...
            .mobile-button { padding: 12px 18px !important; font-size: 14px !important; }
            ...
            .mobile-three-col { display: grid !important; grid-template-columns: repeat(3, 1fr) !important; gap: 6px !important; }
            .mobile-ultra-compact { padding: 6px 8px !important; margin: 3px 0 !important; }
          ...
          @media only screen and (max-width: 480px) {
            ...
            .mobile-compact { padding: 6px !important; }
            .mobile-font-large { font-size: 18px !important; }
            .mobile-font-medium { font-size: 14px !important; }
            .mobile-font-small { font-size: 12px !important; }
            .mobile-button { padding: 10px 15px !important; font-size: 13px !important; }
            .mobile-destinations { font-size: 12px !important; }
            .mobile-price { font-size: 15px !important; }
      ...
      <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Arial, sans-serif; background-color: #f8fafc;">
        ...
        <a href="https://www.fly2any.com" style="text-decoration: none; color: inherit; display: block;">
          ...
          <!-- Header Ultra Compacto com Urgência -->
          <div style="background: linear-gradient(135deg, #dc2626 0%, #ef4444 100%); color: white; padding: 15px; text-align: center; position: relative;" class="mobile-compact">
            <!-- Banner de Urgência TOP -->
            <div style="background: rgba(0,0,0,0.6); margin: -15px -15px 10px -15px; padding: 8px; font-size: 14px; font-weight: 900;" class="mobile-font-small">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;" class="mobile-stack">
              <div style="display: flex; align-items: center; gap: 10px;">
                <!-- Logo Fly2Any -->
                <div style="color: white; font-size: 26px; font-weight: 900;">✈️ FLY2ANY</div>
                <div style="text-align: left;">
                  <p style="margin: 0; font-size: 15px; opacity: 0.95; font-weight: 600; line-height: 1.2;" class="mobile-font-small">🏆 21 anos conectando você ao mundo<br>50K+ clientes satisfeitos</p>
                </div>
              </div>
              <div style="text-align: right; font-size: 20px; font-weight: 900; background: rgba(251,191,36,0.2); padding: 10px 15px; border-radius: 15px; border: 2px solid rgba(251,191,36,0.6);" class="mobile-font-medium">
                <div style="color: #fbbf24; text-shadow: 0 1px 2px rgba(0,0,0,0.3);">$699</div>
                <div style="font-size: 12px; opacity: 0.8; color: rgba(255,255,255,0.9);">A partir de</div>
              </div>
            </div>
          </div>

          <!-- Oferta Principal com Escassez -->
          <div style="padding: 15px; background: linear-gradient(180deg, #fef3c7 0%, #ffffff 100%);" class="mobile-compact">
            <!-- Header + Badge de Escassez -->
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;" class="mobile-stack">
              <div>
                <h2 style="color: #dc2626; font-size: 24px; margin: 0; font-weight: 900;" class="mobile-font-medium">🎯 SuperOFERTA</h2>
                <div style="font-size: 12px; color: #dc2626; font-weight: 700;">⚡ 18/100 vagas restantes</div>
              </div>
              <div class="limited-badge" style="background: linear-gradient(135deg, #dc2626, #b91c1c); color: white; padding: 6px 12px; border-radius: 20px; font-size: 11px; font-weight: 900;">
                🔥 LIMITADO
              </div>
            </div>
            
            <!-- Barra de Escassez -->
            <div class="scarcity-bar" style="margin: 8px 0;">
              <div class="scarcity-fill"></div>
            </div>
            
            <!-- Grid de Destinos Premium -->
            <div style="background: white; padding: 15px; border-radius: 15px; margin: 10px 0; border: 2px solid #fbbf24;" class="shadow-premium">
              <div style="background: linear-gradient(135deg, #fbbf24, #f59e0b); color: white; padding: 6px; border-radius: 8px; margin: -15px -15px 12px -15px; text-align: center; font-weight: 900; font-size: 13px;">
                💰 PREÇOS HISTÓRICOS - NUNCA VISTO!
              </div>
              
              <!-- Grid 3 destinos -->
              <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px;" class="mobile-grid">
                <div style="text-align: center; padding: 8px; background: linear-gradient(135deg, #fef3c7, #fff7ed); border-radius: 8px;" class="mobile-grid-item mobile-ultra-compact">
                  <div style="font-size: 14px; font-weight: 800; color: #374151;" class="mobile-destinations">✈️ Miami</div>
                  <div style="color: #dc2626; font-size: 20px; font-weight: 900;" class="mobile-price gradient-text">$699</div>
                  <div style="font-size: 10px; color: #6b7280; text-decoration: line-through;">era $990</div>
                </div>
                
                <div style="text-align: center; padding: 8px; background: linear-gradient(135deg, #fef3c7, #fff7ed); border-radius: 8px;" class="mobile-grid-item mobile-ultra-compact">
                  <div style="font-size: 14px; font-weight: 800; color: #374151;" class="mobile-destinations">✈️ NY</div>
                  <div style="color: #dc2626; font-size: 20px; font-weight: 900;" class="mobile-price gradient-text">$699</div>
                  <div style="font-size: 10px; color: #6b7280; text-decoration: line-through;">era $950</div>
                </div>
                
                <div style="text-align: center; padding: 8px; background: linear-gradient(135deg, #fef3c7, #fff7ed); border-radius: 8px;" class="mobile-grid-item mobile-ultra-compact">
                  <div style="font-size: 14px; font-weight: 800; color: #374151;" class="mobile-destinations">✈️ Orlando</div>
                  <div style="color: #dc2626; font-size: 20px; font-weight: 900;" class="mobile-price gradient-text">$699</div>
                  <div style="font-size: 10px; color: #6b7280; text-decoration: line-through;">era $980</div>
                </div>
              </div>
              
              <div style="text-align: center; font-size: 11px; color: #6b7280; margin-top: 8px; font-weight: 600;">
                Ida e volta • Taxas incluídas • Todos para Belo Horizonte
              </div>
            </div>
            
            <!-- CTA + Timer -->
            <div style="display: flex; justify-content: space-between; align-items: center; gap: 12px; margin: 12px 0;" class="mobile-stack">
              <a href="https://www.fly2any.com" style="background: linear-gradient(135deg, #dc2626, #ef4444); color: white; padding: 15px 30px; text-decoration: none; border-radius: 25px; font-weight: 900; font-size: 18px; flex: 1; text-align: center;" class="mobile-button pulse">
                🚀 GARANTIR AGORA
              </a>
            </div>
            
            <!-- Bônus Premium -->
            <div style="background: linear-gradient(135deg, #f0fdf4, #ecfdf5); padding: 10px 12px; border-radius: 10px; border-left: 4px solid #10b981; font-size: 13px; margin: 10px 0;" class="mobile-font-small">
          ...
          <div style="padding: 12px 15px; background: linear-gradient(135deg, #f8fafc, #e2e8f0);" class="mobile-compact">
            <!-- Estatísticas + Depoimento -->
            <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 10px; align-items: center;" class="mobile-grid">
              <!-- Stats compactas -->
              <div style="background: white; padding: 10px; border-radius: 10px; text-align: center;" class="shadow-premium mobile-grid-item">
                <div style="font-size: 18px; font-weight: 900; color: #dc2626; margin-bottom: 3px;" class="mobile-font-medium">50K+</div>
                <div style="font-size: 10px; color: #6b7280; font-weight: 700; line-height: 1.2;">Clientes • 21 anos • 98% satisfação</div>
              </div>
              
              <!-- Depoimento condensado -->
              <div style="background: white; padding: 10px; border-radius: 10px; border-left: 4px solid #fbbf24;" class="shadow-premium mobile-grid-item">
                <div style="font-size: 13px; font-weight: 700; color: #dc2626; margin-bottom: 3px;" class="mobile-font-small">
                  ⭐⭐⭐⭐⭐ Maria S. • São Paulo ✓
                </div>
        ...
        <div style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); color: #f1f5f9; padding: 15px; text-align: center; width: 100%; margin-top: 0; position: relative;" class="mobile-compact">
          <div style="position: absolute; top: 0; left: 0; right: 0; height: 3px; background: linear-gradient(135deg, #dc2626, #fbbf24, #10b981);"></div>
          
          <!-- Contatos + CTA Final -->
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;" class="mobile-stack">
            <div style="display: flex; align-items: center; gap: 8px;">
              <div style="color: white; font-size: 18px; font-weight: 900;">✈️ FLY2ANY</div>
              <div style="text-align: left;">
                <div style="font-size: 10px; color: #64748b; font-weight: 600; line-height: 1.2;">21 anos • 50K+ clientes • IATA</div>
              </div>
            </div>
            
            <a href="https://www.fly2any.com" style="background: linear-gradient(135deg, #fbbf24, #f59e0b); color: #1e293b; padding: 10px 20px; text-decoration: none; border-radius: 18px; font-weight: 900; font-size: 13px;" class="mobile-button">
              🚀 GARANTIR AGORA
            </a>
          </div>
          
          <!-- Contatos horizontais -->
          <div style="display: flex; gap: 8px; justify-content: center;" class="mobile-stack">
            <a href="https://wa.me/1151944717" style="background: rgba(37, 211, 102, 0.2); color: #25d366; padding: 8px 12px; border-radius: 15px; text-decoration: none; font-weight: 800; font-size: 12px;" class="mobile-font-small">
              📱 WhatsApp
            </a>
            <a href="mailto:info@fly2any.com" style="background: rgba(96, 165, 250, 0.2); color: #60a5fa; padding: 8px 12px; border-radius: 15px; text-decoration: none; font-weight: 800; font-size: 12px;" class="mobile-font-small">
              📧 Email
            </a>
          </div>
          
          <!-- Unsubscribe link -->
          <div style="font-size: 9px; color: #64748b; margin-top: 10px; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 8px;">
