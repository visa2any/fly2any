            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                  <div style={{ color: 'rgb(37, 99, 235)', background: 'rgb(219, 234, 254)', padding: '8px', borderRadius: '50%' }}>
                    <svg style={{ width: '12px', height: '12px' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <div>
                    <h4 style={{ fontWeight: '600', color: 'white', marginBottom: '4px' }}>Telefone</h4>
                    <p style={{ color: 'rgb(219, 234, 254)' }}>+1 (555) 123-4567</p>
                    <p style={{ fontSize: '14px', color: 'rgb(191, 219, 254)' }}>Segunda a Sexta: 8h às 18h (EST)</p>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                  ...
                  <div>
                    <h4 style={{ fontWeight: '600', color: 'white', marginBottom: '4px' }}>E-mail</h4>
                    <p style={{ color: 'rgb(219, 234, 254)' }}>contato@fly2any.com</p>
                    <p style={{ fontSize: '14px', color: 'rgb(191, 219, 254)' }}>Resposta em até 2 horas</p>
                  </div>
                </div>

                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                  <div style={{ color: 'rgb(220, 38, 38)', background: 'rgb(254, 226, 226)', padding: '8px', borderRadius: '50%' }}>
                    <svg style={{ width: '12px', height: '12px' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h4 style={{ fontWeight: '600', color: 'white', marginBottom: '4px' }}>Endereço</h4>
