...
// ===========================
// TYPE DEFINITIONS (Re-exported from shared types)
// ===========================

// Re-export types from shared location for backwards compatibility
export type { AIAnalyticsEvent, AIAnalyticsStats } from '@/lib/types/ai-analytics';
import type { AIAnalyticsEvent, AIAnalyticsStats } from '@/lib/types/ai-analytics';
