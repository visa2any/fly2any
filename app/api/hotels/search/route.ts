...
/**
 * GET endpoint for backward compatibility with existing LiteAPI implementation
 * Query parameters: cityCode, checkinDate, checkoutDate, adults, children, currency
 */
