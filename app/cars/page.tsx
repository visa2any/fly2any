  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <MaxWidthContainer className="relative overflow-hidden md:overflow-visible" noPadding={true} style={{ padding: '12px 0 8px' }}>
          <div className="px-4 md:px-6">
            <div className="flex items-baseline gap-1 md:gap-3 flex-wrap animate-fadeIn">
              ...
              <span className="separator-dot text-teal-400 font-medium text-base md:text-xl">•</span>
      ...
      <style jsx>{`
        ...
        .hero-title { color: #0f766e; text-shadow: 0 1px 2px rgba(0, 0, 0, 0.1), 0 2px 8px rgba(15, 118, 110, 0.15); position: relative; z-index: 10; transform: translateZ(0); backface-visibility: hidden; isolation: isolate; font-weight: 800; }
      ...
      <div className="bg-gradient-to-br from-gray-50 to-white py-8 md:py-12">
        <MaxWidthContainer>
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">{t.vehicleTypesTitle}</h2>
            <p className="text-gray-600">{t.vehicleTypesSubtitle}</p>
          </div>
      ...
      <div className="bg-white py-8 md:py-12">
        <MaxWidthContainer>
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">{t.companiesTitle}</h2>
            <p className="text-gray-600">{t.companiesSubtitle}</p>
          </div>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 py-8 md:py-12">
        <MaxWidthContainer>
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">{t.insuranceTitle}</h2>
            <p className="text-gray-600">{t.insuranceSubtitle}</p>
          </div>
      ...
      <div className="bg-white py-8 md:py-12">
        <MaxWidthContainer>
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">{t.locationsTitle}</h2>
            <p className="text-gray-600">{t.locationsSubtitle}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
      ...
      <div className="bg-gradient-to-br from-teal-50 to-emerald-50 py-8 md:py-12">
        <MaxWidthContainer>
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">{t.fuelPoliciesTitle}</h2>
            <p className="text-gray-600">{t.fuelPoliciesSubtitle}</p>
          </div>
      ...
      <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-8 md:py-12">
        <MaxWidthContainer>
          <div className="mb-8">
            ...
            <p className="text-gray-600">Everything you need to know about renting cars with Fly2Any</p>
          </div>
