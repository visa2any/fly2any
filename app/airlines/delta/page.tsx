      ...
      <section className="py-12 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-white/5 rounded-2xl"><Shield className="w-10 h-10 text-blue-400 mx-auto mb-3" /><h3 className="font-bold mb-2">Best Price Guarantee</h3><p className="text-gray-400 text-sm">Compare Delta fares from 900+ sources.</p></div>
