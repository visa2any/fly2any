      ...
      <div style={{ maxWidth: '1600px', margin: '0 auto' }} className="px-2 py-2 lg:p-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 lg:gap-4">
          ...
          <main className="lg:col-span-8">
            {/* Sort & Filter Bar - Mobile: Filter left, Sort right */}
            <div className="flex items-center justify-between mb-2 lg:mb-4 gap-2">
              ...
              <div className="flex items-center gap-1.5 min-w-0 flex-1">
                ...
                <div className="flex items-center gap-1 lg:gap-1.5 overflow-x-auto lg:overflow-visible lg:flex-wrap scrollbar-hide -mx-1 px-1 lg:mx-0 lg:px-0">
                  {[
                    ...
                    <button
                      ...
                      className={`px-2 lg:px-3 py-1 lg:py-1.5 rounded-lg font-semibold text-[10px] lg:text-xs transition-all duration-200 flex-shrink-0 touch-manipulation ${
                        sortBy === key
                          ...
                          : 'bg-white/90 backdrop-blur-sm text-slate-700 border border-slate-200 lg:border-2 active:bg-primary-50'
                      }`}
                    >
              ...
              <span className="text-xs lg:text-sm font-semibold text-slate-600 flex items-center gap-1 flex-shrink-0">
                <span className="inline-flex items-center justify-center w-5 h-5 lg:w-7 lg:h-7 bg-primary-100 text-primary-700 rounded-full text-[10px] lg:text-xs font-bold">
                  {sortedHotels.length}
                </span>
