      ...
      <div className="max-w-6xl mx-auto px-4 py-8 print:py-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8 no-print">
          <div className="relative">
            ...
            >
              <svg className="w-6 h-6 mx-auto mb-2 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div key={passenger.id} className="border rounded-xl p-4 print:border-gray-300">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-lg font-bold text-blue-600">{passenger.seat}</p>
                      </div>
                    </div>
        ...
        {/* Customer Support */}
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-white print:bg-blue-600 print:p-4">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold mb-2 print:text-xl">{t.needHelp}</h2>
            <p className="text-blue-100">{t.contactSupport} - {t.available24x7}</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="text-sm text-blue-100">+55 11 5194-4717</div>
            </a>
            ...
            >
              ...
              <div className="text-sm text-blue-100">+1 (315) 306-1646</div>
            </a>
            ...
            >
              ...
              <div className="text-sm text-blue-100 break-all">fly2any.travel@gmail.com</div>
            </a>
          </div>
        </div>
