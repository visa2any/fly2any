...
const DESTINATIONS_DB: Record<string, DestinationData> = {
  ...
  'barcelona': {
    ...
    code: 'BCN',
    airportCode: 'BCN',
    description: 'A vibrant Mediterranean city famous for its stunning architecture, beautiful beaches, and rich Catalan culture. From Gaudí\'s masterpieces to Gothic Quarter charm, world-class cuisine to lively nightlife, Barcelona captivates every visitor.',
    latitude: 41.3851,
    longitude: 2.1734,
    ...
    bestTimeToVisit: ['May', 'June', 'September', 'October'],
    averageTemperature: { summer: '82°F (28°C)', winter: '59°F (15°C)' },
    popularAttractions: [
      'Sagrada Familia',
      'Park Güell',
      'La Rambla',
    ...
    nearbyAirports: [
      { code: 'BCN', name: 'Barcelona-El Prat Airport', distance: '8 miles' },
      { code: 'GRO', name: 'Girona-Costa Brava Airport', distance: '60 miles' },
    ],
    relatedDestinations: ['Madrid', 'Paris', 'Rome', 'Lisbon', 'Valencia'],
    keywords: ['Barcelona flights', 'Spain vacation', 'cheap flights to Barcelona', 'BCN flights', 'Gaudi Barcelona'],
  },
  'paris': {
    city: 'Paris',
    country: 'France',
